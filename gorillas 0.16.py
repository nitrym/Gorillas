...
def draw_banana(x, y):
    # Zeichne eine gebogene Form für die Banane
    banana = canvas.create_arc(x, y, x + 30, y + 10, start=0, extent=180, fill="yellow", outline="orange", width=2)
    return banana
...
def throw_banana():
    ...
    banana = draw_banana(x, y)  # Verwende die neue Banane
